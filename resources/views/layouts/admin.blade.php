...
<head>
    ...
    <title>@yield('title', 'Quản trị') - Admin Panel</title>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a href="{{ route('admin.courses.index') }}"
                    class="sidebar-menu-link {{ request()->routeIs('admin.courses.*') && !request()->routeIs('admin.courses.lessons.*') ? 'active' : '' }}">
            ...
            <li class="sidebar-menu-item">
                <a href="{{ route('admin.sliders.index') }}"
                    class="sidebar-menu-link {{ request()->routeIs('admin.sliders.*') ? 'active' : '' }}">
            ...
            <li class="sidebar-menu-item">
                <a href="{{ route('admin.revenue.index') }}"
                    class="sidebar-menu-link {{ request()->routeIs('admin.revenue.*') ? 'active' : '' }}">
