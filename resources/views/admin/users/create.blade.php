    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-user-plus me-2 text-primary"></i>Thông Tin Tài Khoản</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                   value="{{ old('name') }}" placeholder="Nhập tên đăng nhập..." required>
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted">Mật khẩu tối thiểu 4 ký tự</small>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                ...
                                <option value="blocked" {{ old('status') == 'blocked' ? 'selected' : '' }}>Khóa</option>
                            </select>
