        ...
        <div class="auth-body">
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="form-group input-with-icon">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', 'admin')); ?>" class="form-control"
                        placeholder="Email hoặc Tên đăng nhập" required>
                    <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger small mt-2" style="font-size: 12px;"><?php echo e($message); ?></div>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="auth-footer">
                    <div class="small">Chưa có tài khoản? <a href="<?php echo e(route('register.form')); ?>" class="auth-link">Đăng
                            ký tham gia</a></div>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\khoahoc\resources\views/auth/login.blade.php ENDPATH**/ ?>