                        ...
                        <div class="course-price mt-auto">
                            ...
                            <?php else: ?>
                                <?php if($course->sale_price): ?>
                                    <span class="price-current"><?php echo e(number_format($course->sale_price, 0, ',', '.')); ?>đ</span>
                                    <span class="price-original" style="font-size: 13px; text-decoration: line-through; color: var(--text-muted); margin-left:8px;"><?php echo e(number_format($course->price, 0, ',', '.')); ?>đ</span>
                                <?php else: ?>
                                    <span class="price-current"><?php echo e(number_format($course->price, 0, ',', '.')); ?>đ</span>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\khoahoc\resources\views/explore.blade.php ENDPATH**/ ?>