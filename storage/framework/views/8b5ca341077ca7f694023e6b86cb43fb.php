...
<body>
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-brand">
            ...
            <span class="sidebar-brand-text">LMS Admin</span>
        </a>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.courses.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.courses.*') && !request()->routeIs('admin.courses.lessons.*') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.sliders.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.sliders.*') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
            ...
            <li class="sidebar-menu-item">
                <a href="<?php echo e(route('admin.revenue.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.revenue.*') ? 'active' : ''); ?>">
            ...
            <div class="navbar-right">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="<?php echo e(route('profile.show')); ?>"><i class="fas fa-user me-2"></i>Hồ sơ</a></li>
...
<?php /**PATH C:\xampp\htdocs\TTS\khoahoc\resources\views/layouts/admin.blade.php ENDPATH**/ ?>