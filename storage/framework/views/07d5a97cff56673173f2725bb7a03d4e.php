        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-item">
                <a href="<?php echo e(route('explore')); ?>"
                    class="sidebar-nav-link <?php echo e(request()->routeIs('explore') ? 'active' : ''); ?>">
            ...
            <?php $__currentLoopData = $sidebarCategories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($category): ?>
                    <li class="sidebar-nav-item">
                        <a href="<?php echo e(route('explore', ['category' => $category->id])); ?>"
                            class="sidebar-nav-link <?php echo e(request('category') == $category->id ? 'active' : ''); ?>">
                ...
                <?php if(auth()->user()->isAdmin()): ?>
                    ...
                    <li class="sidebar-nav-item">
                        <a href="<?php echo e(route('admin.courses.index')); ?>"
                            class="sidebar-nav-link <?php echo e(request()->routeIs('admin.courses.*') ? 'active' : ''); ?>">
                    ...
                    <li class="sidebar-nav-item">
                        <a href="<?php echo e(route('admin.categories.index')); ?>"
                            class="sidebar-nav-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>">
                    ...
                    <li class="sidebar-nav-item">
                        <a href="<?php echo e(route('admin.sliders.index')); ?>"
                            class="sidebar-nav-link <?php echo e(request()->routeIs('admin.sliders.*') ? 'active' : ''); ?>">
                    ...
                    <li class="sidebar-nav-item">
                        <a href="<?php echo e(route('admin.orders.index')); ?>"
                            class="sidebar-nav-link <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>">
                ...
                <?php elseif(auth()->user()->isInstructor()): ?>
                    ...
                    <li class="sidebar-nav-item">
                        <a href="<?php echo e(route('instructor.courses.index')); ?>"
                            class="sidebar-nav-link <?php echo e(request()->routeIs('instructor.courses.*') ? 'active' : ''); ?>">
                    ...
                    <li class="sidebar-nav-item">
                        <a href="<?php echo e(route('profile.show')); ?>"
                            class="sidebar-nav-link <?php echo e(request()->routeIs('profile.show') ? 'active' : ''); ?>">
                ...
                <?php else: ?>
                    ...
                    <li class="sidebar-nav-item">
                        <a href="<?php echo e(route('profile.orders')); ?>"
                            class="sidebar-nav-link <?php echo e(request()->is('orders') ? 'active' : ''); ?>">
                ...
                <?php else: ?>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end glass-dropdown">
                            ...
                            <?php if(auth()->user()->isAdmin()): ?>
                                <li><a class="dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>"><i
                                            class="fas fa-chart-pie me-2 text-primary"></i>Bảng điều khiển</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('admin.users.index')); ?>"><i
                                            class="fas fa-users me-2 text-primary"></i>Quản lý người dùng</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('admin.courses.index')); ?>"><i
                                            class="fas fa-book me-2 text-primary"></i>Quản lý khóa học</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('admin.categories.index')); ?>"><i
                            ...
                            <?php else: ?>
                                ...
                                <li><a class="dropdown-item" href="<?php echo e(route('profile.orders')); ?>"><i
...
</html><?php /**PATH D:\xampp\htdocs\khoahoc\resources\views/layouts/app.blade.php ENDPATH**/ ?>