...
<div class="orders-split-view">
    ...
    <div class="orders-list-sidebar">
        <div class="sidebar-header">
            <h5 class="mb-0 fw-bold">Đơn hàng <span class="badge bg-primary ms-2"><?php echo e($orders->total()); ?></span></h5>
        </div>
        
        <div class="orders-scroll-area">
            <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="order-item-card <?php echo e(request('order_id') == $order->id ? 'active' : ''); ?>" 
                     id="order-card-<?php echo e($order->id); ?>"
                     onclick="loadOrderDetail('<?php echo e(route('admin.orders.show', $order)); ?>', <?php echo e($order->id); ?>)">
                    <div class="order-meta">
                        <span class="order-id">#<?php echo e(str_pad($order->id, 5, '0', STR_PAD_LEFT)); ?></span>
                        <small class="text-muted"><?php echo e($order->created_at->format('d/m H:i')); ?></small>
                    </div>
                    <div class="customer-name mb-1"><?php echo e($order->user->name); ?></div>
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="order-price small"><?php echo e((int) $order->total_price); ?>đ</span>
                        <?php switch($order->status):
                            case ('awaiting'): ?> <span class="badge bg-secondary">Chờ duyệt</span> <?php break; ?>
                            <?php case ('pending'): ?> <span class="badge bg-warning">Xử lý</span> <?php break; ?>
                            <?php case ('shipping'): ?> <span class="badge bg-info">Giao hàng</span> <?php break; ?>
                            <?php case ('delivered'): ?> <span class="badge bg-success">Đã giao</span> <?php break; ?>
                            <?php case ('completed'): ?> <span class="badge bg-success">Xong</span> <?php break; ?>
                            <?php case ('cancelled'): ?> <span class="badge bg-danger">Hủy</span> <?php break; ?>
                        <?php endswitch; ?>
                    </div>
                </div>
        ...
        <?php if($orders->hasPages()): ?>
            <div class="p-2 border-top bg-white">
                <?php echo e($orders->withQueryString()->links('pagination::simple-bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\khoahoc\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>